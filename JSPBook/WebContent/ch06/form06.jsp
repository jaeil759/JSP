...
<body>
	...
	<form action = "form06_process.jsp" name = "member" method = "post">
		...
		<p>취미 : 독서<input type = "checkbox" name = "hobby" checked = "checked" value = "독서"/>
		 운동<input type = "checkbox" name = "hobby" checked = "checked" value = "운동"/>
		 영화<input type = "checkbox" name = "hobby" checked = "checked" value = "영화"/>
		</p>
