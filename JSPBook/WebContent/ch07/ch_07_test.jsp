...
<body>
		...
		2) ch07_test_process.jsp로 입력한 데이터를 전송해주세요
	--> 	
	
		<h3> 입력하든가 말든가 </h3>
	<form action = "ch_07_test_process.jsp" name = "member" method = "post" enctype='multipart/form-data'>
		...
		<p>파일 : <input type = "file" name = "filename" multiple="multiple"/>
		</p>
		<p>
